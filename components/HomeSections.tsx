...
function Card({title,desc}:{title:string;desc:string}){
  return (
    <div className="rounded-2xl p-5 border bg-white/60 dark:bg-white/5">
...
export default function HomeSections(){
  ...
  return (
    <div className="max-w-5xl mx-auto px-4">
      {/* Hero */}
      <section className="py-16" id="top" aria-labelledby="hero-title">
        <motion.h1 id="hero-title" className="text-3xl md:text-4xl font-bold mb-3"
